...
export const analyzeBrandCompliance = async (
  ...
  const prompt = `
    ...
    4. Logo Guidelines: ${guidelines.logoGuidelines}
    5. Color Palette: ${guidelines.colorPalette.join(", ")}
    6. Typography/Fonts: ${guidelines.typographyFonts.join(", ")}
    7. Tone of Voice: ${guidelines.toneOfVoice}

    Critical Checks:
    - CSS styles must align with the Color Palette and Typography.
    - Content copy must reflect the Brand Narrative and Tone of Voice.
    - Semantic HTML and accessibility must reflect the Brand Values.
    - Images and SVGs must align with Logo Guidelines.
        ...
        properties: {
          ...
          visualMetrics: {
            ...
            properties: {
              ...
              visualIdentity: {
                type: Type.NUMBER,
                description: "Score for Pillar 4, 5, 6",
              },
              tonalConsistency: {
                type: Type.NUMBER,
